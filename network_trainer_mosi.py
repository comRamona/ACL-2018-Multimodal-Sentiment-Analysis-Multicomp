...
train_data = ExampleMOSITextProvider(which_set="train", batch_size=batch_size, rng=rng)
val_data = ExampleMOSITextProvider(which_set="valid", batch_size=batch_size, rng=rng)
test_data = ExampleMOSITextProvider(which_set="test", batch_size=batch_size, rng=rng)

...
batch_size = 32
batch_norm = False
max_first = True #means not doing sampling yet
...
experiment_name = "{}_ep_{}_bs_{}_bn_{}_dr_{}_nl_{}_ml_{}".format(experiment_prefix, epochs,
...
def pad(data, max_len):
    ...
    if max_first:
        ...
        #perform some sampling thing here
        return data[-max_len:]
...
if __name__ == "__main__":
    ...
    if batch_norm:
        ...
        model.add(Bidirectional(LSTM(64),input_shape=(max_len, x_train.shape[2]), merge_mode="concat"))

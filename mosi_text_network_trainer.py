from text_data_providers import MOSITextProvider
import argparse
import numpy as np
...
train_data =  MOSITextProvider(which_set="train", batch_size=batch_size, rng=rng, conv=True)
val_data =  MOSITextProvider(which_set="valid", batch_size=batch_size, rng=rng, conv=True)
test_data =  MOSITextProvider(which_set="test", batch_size=batch_size, rng=rng, conv=True)
